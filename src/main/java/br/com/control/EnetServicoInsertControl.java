...
public class EnetServicoInsertControl {
    ...
    private static final String path = "C:\\Users\\jose.renato\\Desktop\\ENETSERVICO\\sql.txt";
    public static void main(String[] args) throws IOException, BiffException {
        ...
        Workbook workbook = Workbook.getWorkbook(new File("C:\\Users\\jose.renato\\Desktop\\ENETSERVICO\\ENETSERVICOSP - COMPLETO.xls"),ws);
